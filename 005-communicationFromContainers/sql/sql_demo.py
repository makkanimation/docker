...
def create_connection():
    return pymysql.connect(
        host="172.16.0.186",  # Your MySQL server host
        user="docker",       # Your MySQL username
        password="Docker@123",  # Your MySQL password
        database="demodocker"    # Your MySQL database name
    )
