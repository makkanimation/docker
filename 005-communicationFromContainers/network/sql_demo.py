...
def create_connection():
    return pymysql.connect(
        host="mysqldb",  # there in same network use mysql container name, mine is mysqldb
        user="root",       # default username
        password="root",  # while running mysql docker we have mentioned MYSQL_ROOT_PASSWORD
        database="demodocker"    # while running mysql docker we have mentioned MYSQL_DATABASE
    )
